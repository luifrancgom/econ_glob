...
- January 26
    ...
    + __Virtual meeting Presentation Syllabus__
        ...
        + __Prerequisites__:
            + Review the course program in advance, which can be downloaded by following the route _Primer corte 30% > Learning Resources > Support material > Presentations > 000_syllabus_econ_glob_2021_1
...
- March 25
    ...
    + __Virtual meeting Political economy and ethics__
        + __Opening time__: 20:00 - 20:45 hours
        + Prerequisites:
