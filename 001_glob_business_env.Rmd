...
- This presentation is based on [wildInternationalBusinessChallenges2020, Chapter 1]
...
read_html(x = "https://en.wikipedia.org/wiki/List_of_largest_companies_by_revenue") %>%
    ...
    bind_rows(wb(country = c("COL", "SWE", "THA", "ZAF", "FIN"),
...
- Other indexes
    ...
    + A complete survey can be found in [@caselliTryingMeasureGlobalization2012a, Chapter 3] using a state-based approach
...
# Data
get_dataset(set_name = "ds_globidx.v2019") %>%
  ...
  # Plot
  ggplot() +
  geom_point(aes(x = date, y = value, fill = country),
             shape = 21,
             color = "black",
             show.legend = FALSE) +
    geom_line(aes(x     = date,
    ...
    labs(x        = "Year",
         y        = "KOF index",
         color    = "",
         title    = "KOF Globalization Index for Colombia and the World: 1970-2017",
...
- Jobs and wages: Globalization erodes standard of livings and ruins ways of life?
    ...
    + Arguments against and in favor of globalization [@wildInternationalBusinessChallenges2020, Chapter 1, Section 1.4]
...
- Income inequality: Globalization increase inequality within nations, between nations or around the world?
    ...
    + Global inequality
      ...
      + The main debate in [wildInternationalBusinessChallenges2020, Chapter 1, Section 1.5] is about inequality. However, the authors mix the concepts of poverty and inequality several times, generating, _in my opinion_, confusion to the reader.
...
- Global business environment scheme [@wildInternationalBusinessChallenges2020, Fig 1.3]
