...
#   filter(str_detect(string = set_description, pattern = "[Gg]lob"))
                     ...
                     # index version 2019
kofdata_col_wld <- kofdata::get_collection(collection_name = "ds_globidx.v2019") %>%
  ...
  bind_rows(kofdata::get_collection(collection_name = "ds_globidx.v2019") %>%
