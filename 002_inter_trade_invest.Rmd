...
- Colombian exports __HS 4 digits (HS92) edition__ year 1997 [@oec_observatory_2022]

```{r, out.width="100%"}

include_graphics(path = "002_col_exports_1997_hs4_92.png")
```
    
# Patterns of international trade 

- Colombian exports __HS 4 digits (HS92) edition__ year 2019 [@oec_observatory_2022]

```{r, out.width="100%"}

include_graphics(path = "002_col_exports_2019_hs4_92.png")
```

# Patterns of international trade 

- Coffee exporters __HS 4 digits (0901) (HS92) edition__ year 1997 [@oec_observatory_2022]
...
- Coffee exporters __HS 4 digits (0901) (HS92) edition__ year 2019 [@oec_observatory_2022]

```{r, out.width="100%"}

include_graphics(path = "002_coffee_exports_2019_hs4_92.png")
```
