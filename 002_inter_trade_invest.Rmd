...
date: 2020-01-28 17:57:27 GMT -05:00
output:
  beamer_presentation:
    colortheme: dolphin
...
tbl_exports_imports %>%
    ...
    labs(x        = "",
         y        = "",
         title    = "Top 10 importers in year {unique(tbl_exports_imports$date)}",
         subtitle = str_glue("Variables Units: current USD Billions (Long scale)
...
tbl_exports_imports %>%
    ...
    labs(x        = "",
         y        = "",
         title    = "Top 10 per-capita exporters in year {unique(tbl_exports_imports$date)}",
...
tbl_exports_imports %>%
    ...
    labs(x        = "",
         y        = "",
         title    = "Top 10 per-capita importers in year {unique(tbl_exports_imports$date)}",
         subtitle = str_glue("Variables Units: current USD per inhabitant
                              Imports WDI code : BM.GSR.GNFS.CD,
                              Populations WDI code : SP.POP.TOTL"),
         caption  = str_glue("Source: World Development Indicators - World Bank,
