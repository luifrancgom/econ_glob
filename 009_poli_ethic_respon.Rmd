...
date: 2021-03-12 11:41:08 GMT -05:00
output:
  beamer_presentation:
    colortheme: dolphin
...
# Data
tax_complex_ind_2016 <- read_excel(path      = "009_tax_complexity_2021-03-12.xlsx", 
           sheet     = 2, 
           range     = "A1:C101", 
           col_names = TRUE) %>% 
...
tax_complex_ind_2016 %>% 
  ...
  labs(x        = "Countries",
       ...
       subtitle = str_glue("Year: 2016
                           ...
                           Minimum value: {tax_complex_ind_2016$country[length(tax_complex_ind_2016$country)]} ({tax_complex_ind_2016$tax_complex_ind[length(tax_complex_ind_2016$country)] %>% round(digits = 3)})"),
